        ...
        <div class="flex items-center w-full sm:w-auto justify-between sm:justify-start">
          <router-link to="/app/dashboard" class="flex items-center">
            ...
            <div class="flex items-baseline space-x-2">
              <span class="text-lg sm:text-xl font-heading font-bold text-text">ECIS Portal</span>
              <span class="hidden sm:inline-flex text-xs text-text-muted bg-accent/10 px-2 py-0.5 rounded-full">Admin</span>
            </div>
          </router-link>
          ...
          <button 
            ...
            class="sm:hidden p-2 rounded-lg hover:bg-surface-2 transition-colors"
          >
